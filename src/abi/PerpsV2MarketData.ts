const PERPS_V2_MARKET_DATA_ABI = [
	{
		inputs: [
		...
		outputs: [
			{
				components: [
					...
					{ internalType: 'uint256', name: 'maxKeeperFee', type: 'uint256' },
				],
	...
	{
		constant: true,
		inputs: [{ internalType: 'contract IPerpsV2MarketViews', name: 'market', type: 'address' }],
		name: 'marketDetails',
		outputs: [
			{
				components: [
	...
	{
		constant: true,
		inputs: [{ internalType: 'bytes32[]', name: 'marketKeys', type: 'bytes32[]' }],
		...
		outputs: [
			{
				components: [
					...
					{ internalType: 'uint256', name: 'liquidationPremiumMultiplier', type: 'uint256' },
					{ internalType: 'uint256', name: 'liquidationBufferRatio', type: 'uint256' },
					{ internalType: 'uint256', name: 'maxLiquidationDelta', type: 'uint256' },
					{ internalType: 'uint256', name: 'maxPD', type: 'uint256' },
				],
	...
	},
	{
		constant: true,
		inputs: [
			{ internalType: 'contract IPerpsV2MarketViews', name: 'market', type: 'address' },
...
export { PERPS_V2_MARKET_DATA_ABI };
