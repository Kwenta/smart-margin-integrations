const SMART_MARGIN_FACTORY_ABI = [
	{
	...
	},
	{
		...
		name: 'accounts',
		outputs: [{ internalType: 'bool', name: 'exist', type: 'bool' }],
	...
	},
	{
		inputs: [],
		name: 'newAccount',
		outputs: [{ internalType: 'address payable', name: 'accountAddress', type: 'address' }],
		stateMutability: 'nonpayable',
		type: 'function',
	},
	{
...
export { SMART_MARGIN_FACTORY_ABI };
